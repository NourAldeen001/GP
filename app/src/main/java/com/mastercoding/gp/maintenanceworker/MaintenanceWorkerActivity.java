package com.mastercoding.gp.maintenanceworker;
...
import com.mastercoding.gp.databinding.ActivityMaintenanceWorkerBinding;
...
public class MaintenanceWorkerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    ActivityMaintenanceWorkerBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_maintenance_worker);
        ...
        setSupportActionBar(binding.maintenanceWorkerToolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayShowTitleEnabled(false);
        binding.maintenanceWorkerToolbar.setTitle("");

        binding.navigationDrawer.setNavigationItemSelectedListener(this);

        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(this, binding.maintenanceWorkerDrawerLayout, binding.maintenanceWorkerToolbar,
                R.string.open_nav, R.string.close_nav);
        binding.maintenanceWorkerDrawerLayout.addDrawerListener(toggle);
        toggle.syncState();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        profileImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MaintenanceWorkerActivity.this, "Profile Clicked", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        NavController navController = Navigation.findNavController(MaintenanceWorkerActivity.this, R.id.nav_host_fragment_maintenance_worker);
        if(item.getItemId() == R.id.worker_toolbar_notification){
            if(navController.getCurrentDestination().getId() != R.id.maintenanceWorkerNotificationFragment){
                navController.navigate(R.id.maintenanceWorkerNotificationFragment);
            }
        }
        else if(item.getItemId() == R.id.worker_toolbar_profile){
            if(navController.getCurrentDestination().getId() != R.id.maintenanceWorkerProfileFragment){
                navController.navigate(R.id.maintenanceWorkerProfileFragment);
            }
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(itemId == R.id.nav_profile){
            ...
            if(navController.getCurrentDestination().getId() != R.id.maintenanceWorkerAvailablityFragment){
                navController.navigate(R.id.maintenanceWorkerAvailablityFragment);
            }
        }
        else if(itemId == R.id.nav_terms){
            if(navController.getCurrentDestination().getId() != R.id.maintenanceWorkerTermsFragment){
                navController.navigate(R.id.maintenanceWorkerTermsFragment);
            }
        }
        ...
        binding.maintenanceWorkerDrawerLayout.closeDrawer(GravityCompat.START);
        return true;
    }
