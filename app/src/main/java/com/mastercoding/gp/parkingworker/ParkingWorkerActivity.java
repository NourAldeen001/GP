package com.mastercoding.gp.parkingworker;
...
public class ParkingWorkerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.parkingWorkerToolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayShowTitleEnabled(false);
        binding.parkingWorkerToolbar.setTitle("");

        binding.navigationDrawer.setNavigationItemSelectedListener(this);

        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(this, binding.parkingWorkerDrawerLayout, binding.parkingWorkerToolbar,
                R.string.open_nav, R.string.close_nav);
        binding.parkingWorkerDrawerLayout.addDrawerListener(toggle);
        toggle.syncState();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(itemId == R.id.nav_profile){
            ...
            if(navController.getCurrentDestination().getId() != R.id.parkingWorkerAvailablityFragment){
                navController.navigate(R.id.parkingWorkerAvailablityFragment);
            }
        }
        else if(itemId == R.id.nav_terms){
            if(navController.getCurrentDestination().getId() != R.id.parkingWorkerTermsFragment){
                navController.navigate(R.id.parkingWorkerTermsFragment);
            }
        }
        ...
        binding.parkingWorkerDrawerLayout.closeDrawer(GravityCompat.START);
        return true;
    }
